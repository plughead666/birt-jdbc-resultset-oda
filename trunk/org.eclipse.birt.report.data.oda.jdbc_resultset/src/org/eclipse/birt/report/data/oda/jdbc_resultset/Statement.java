...
public class Statement implements IQuery
{
	...
	public void setJdbcResultSet(java.sql.ResultSet jdbcResultSet) {
	...
	public IResultSet executeQuery( ) throws OdaException
	{
		...
		try
		{
			...
			//check if the JDBC result set is set. If so, return it
			if (this.jdbcResultSet != null)
			{
				return new ResultSet(this.jdbcResultSet);
			}

...
package org.eclipse.birt.report.data.oda.jdbc_resultset.ui;
...
public class JdbcPlugin extends AbstractUIPlugin
{
	...
	public JdbcPlugin( )
	{
		...
		try
		{
			resourceBundle = ResourceBundle.getBundle( "org.eclipse.birt.report.data.oda.jdbc_resultset.ui.nls.JdbcPluginResources" );
		}

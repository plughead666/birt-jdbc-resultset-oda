...
public class GetJDBCName implements IScriptFunctionExecutor {
	private static String DRIVER_CLASS = "odaDriverClass";
	...
	public Object execute(Object[] args, IScriptFunctionContext arg1)
		...
		if (dataSource != null)
		{
			String driverClass = (String) dataSource.getProperty(DRIVER_CLASS);
